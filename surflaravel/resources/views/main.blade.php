          ...
          <div class="col-6 " data-aos="flip-down">
            <form class="form-pos">
              ...
              <div class="mb-3 d-flex gap-3">
                <div class="col-6">
                  <input type="place" class="form-control " id="place" placeholder="Birth place">
                </div>
                <div class="col-6">
              ...
              <div class="mb-3">
                <input type="message" class="form-control py-4" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your Message">
              </div>
              <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                <label class="form-check-label" for="exampleCheck1">Accept privacy policy</label>
              </div>
              <button type="submit" class="btn btn-large btn-info text-white ">Send</button>
            </form>
          </div>
        </div>
